...
def data_generator(run_type='train', cache_path='/home/yukino/Downloads/NLP/CIMD/DEBERT/data_cache.pt', use_cache=True):
...
def train_step(batch_train, model, optimizer, criterion, scaler, get_metric=False):
    ...
    input_ids, attention_mask, token_type_ids, define_ids, define_type_ids, define_cls, match_word_ids, labels, text_sentiment, definition_sentiments = batch_data
...
if __name__ == '__main__':
    if 'ner' in config['ent2id']:
        cache_path = f'/home/yukino/Downloads/NLP/CIMD/DEBERT/{config["ent2id"].split("_")[0]}_ner_data_cache.pt'
    else:
        cache_path = '/home/yukino/Downloads/NLP/CIMD/DEBERT/data_cache.pt'
